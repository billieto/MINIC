...
class unary_plus : public STNode
{
  public:
...
class unary_minus : public STNode
{
  public:
...
class prefix_increment : public STNode
{
  public:
    prefix_increment(expression *expression);

    void accept(Visitor &v) override;
};

class postfix_increment : public STNode
{
  public:
    postfix_increment(expression *expression);

    void accept(Visitor &v) override;
};

class prefix_decrement : public STNode
{
  public:
    prefix_decrement(expression *expression);

    void accept(Visitor &v) override;
};

class postfix_decrement : public STNode
{
  public:
    postfix_decrement(expression *expression);
